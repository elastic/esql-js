...
_Pretty-printing_ is the process of converting an ES|QL AST into a
...
The `BasicPrettyPrinter` prints only _left_ and _right_ multi-line comments,
...
The _wrapping pretty printer_ can print a query to multiple lines, and can wrap
